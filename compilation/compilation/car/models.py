...
class CarPostQuerySet(models.QuerySet):
...
class CarPostManager(models.Manager):

    def get_queryset(self):
        return CarPostQuerySet(self.model, using=self._db)
...
class UploadCar(models.Model):
    ...
    image    = models.ImageField(upload_to='home/static/img/car/',blank=False,null=False)

    objects = CarPostManager()
